...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  $sql = "INSERT INTO `donor` (`username`,`address`,`bloodgroup`,`mobile`,`date`)
  VALUES('$username','$address','$bloodgroup','$mobile','$date')";
...
<?php require 'partial/_navbar.php'?>
    ...
    <h2 class ='text-center' style="color:blue;font-size:30px;">Interested in Donating Blood</h2>
